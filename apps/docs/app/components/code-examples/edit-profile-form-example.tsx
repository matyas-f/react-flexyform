...
const EditProfileFormExample = () => {
  ...
  return (
    <CodeExampleWrapper
      handleReset={() => editProfileFormStore.getState().resetFormState()}
    >
      <Form formStore={editProfileFormStore} />
    </CodeExampleWrapper>
  )
}

export default EditProfileFormExample
